...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { access: @permission.access, attrs: @permission.attrs, model_id: @permission.model_id, role_id: @permission.role_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { access: @permission.access, attrs: @permission.attrs, model_id: @permission.model_id, role_id: @permission.role_id } }
